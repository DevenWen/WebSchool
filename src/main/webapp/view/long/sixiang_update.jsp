...
<body>
	...
	<form action="${pageContext.request.contextPath }/SiXiangServlet?method=updateSiXiang&
	stuid=${SX.stuid}&gradingtype=${SX.gradingtype}" method="post" >
    	<table border="1" align="center" width="60%">
            ...
            <tr>
            	<td>奖分（+）（14分）</td>
                <td><input type="text" name="jiangfen" value="${SX.jiangfen}"/></td>
            </tr>
            <tr>
            	<td>扣分（-）</td>
                <td><input type="text" name="koufen" value="${SX.koufen}"/></td>
            </tr>
             <tr>
                <td>小计</td>
                <td><input type="text" name="count" value="${SX.count}"/></td>
            </tr>
